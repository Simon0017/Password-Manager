...
int main(){
    ...
    DBManager.create_relations(db);
    print("Database initialized and relations created if they didn't exist.\n");
    ...
    while (true)
    {
        ...
        InputManager::Action action = inputManager.get_user_action(user_input);
        inputManager.handle_user_action(action, db);
    }
    ...
    // uiManager.SetAppState(UIManager::AppState::REGISTRATION);
